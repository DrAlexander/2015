...
def getArgs():
    ...
    parser.add_argument('Vig_key', help = "file with key for Vizhiner cipher", default = 'Vig_key')
    parser.add_argument('AES_key', help = "file with key for AES cipher", default = 'AES_key')
    parser.add_argument('port', default = '2015')
